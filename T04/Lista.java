 ...
 * @version 1.0
 */
public class Lista<T> implements Coleccionable<T>, Iterable<T>{
    ...
    private class Nodo<T>{
  	...
  	public Nodo(T elemento){
        ...
        public boolean equals(Nodo<T> n){
            //aqui va tu codigo
    ...
    public boolean equals(Object o){
        ...
        // Aquí va su código.
        if(longitud!=lista.getTamanio())
            return false;
        Nodo<T> aux1=this.cabeza;
        Nodo<T> aux2=lista.cabeza;
    ...
    private static <T extends Comparable<T>> Lista<T> merge(Lista<T> a, Lista<T> b) {
        ...
        int a_idx = 0, b_idx = 0;
     		while(a_idx+1 <= a.getTamanio() || b_idx+1 <= b.getTamanio()) {
     			if(a_idx+1 <= a.getTamanio() && b_idx+1 <= b.getTamanio()) {
     			...
     			} else if(a_idx+1 <= a.getTamanio()) {
     				ret.agregarAlFinal(a.getElemento(a_idx));
     				a_idx++;
     			} else if(b_idx+1 <= b.getTamanio()) {
     				ret.agregarAlFinal(b.getElemento(b_idx));
     				b_idx++;
     			}
     		}
    ...
    @Override public String toString() {
        ...
        s += String.format("%s]", getElemento(getTamanio()-1));
        return s;
    }
